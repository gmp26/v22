...

{
  ...
  # These input values are provided by the calling test environment
  # age.start  <- 25
  # screening     <- 1     # Clinically detected = 0, screen detected = 1
  ...
  ##----------------------------------------------------------------
  ##[WINTON FIX] Fix inputs: (Ignore warnings, inputs are declared in calling environment.)
